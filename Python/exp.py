...
# of 10.50 per hour to test the program (the pay should be 498.75). You should use input to read a
# string and float() to convert the string to a number. Do not worry about error checking the user input
# unless you want to - you can assume the user types numbers properly. Do not name your variable sum
